...
public class MyRecyclerViewAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyRecyclerViewAdapter1(Context myContext, List<Map<String,?>> myDataset,int option){
        mContext=myContext;
        mDataset=myDataset;
        mOption=option;
    }
...
//            vMenu=(ImageView)v.findViewById(R.id.overflow_button);
            ...
            v.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    Log.w("MyRecyclerviewAdapter1","test");
                    if(mListener!=null){
                        Log.w("MyRecyclerviewAdapter1","not null mListener");
                        Log.d("content", (String)mDataset.get(getPosition()).get("userid"));
